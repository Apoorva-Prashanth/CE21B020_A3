...
# Load CSV
df = pd.read_csv("C:/Users/APOORVA/Downloads/predictions_vanilla - test_predictions_embed256_hid128_enc2_dec1_LSTM_drop0.35_beam5.csv")  #submitted in the repo

# Load custom Malayalam font
font_path = "C:/Users/APOORVA/Downloads/Noto_Sans_Malayalam/NotoSansMalayalam-VariableFont_wdth,wght.ttf"  #download malayalam font from Google and specify the local path
